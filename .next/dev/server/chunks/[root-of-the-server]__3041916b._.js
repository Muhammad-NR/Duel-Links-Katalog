...
;
;
async function GET(request, { params } // <-- Pake Promise
) {
    const { id } = await params; // <-- Await dulu
    const deck = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$decks$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DECKS_DATA"].find((d)=>d.id === id);
    if (!deck) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3041916b._.js.map