...
const initFirebase = async ()=>{
    if (!auth.currentUser) {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signInAnonymously"])(auth);
...
async function GET(request, { params }) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["initFirebase"])();
        // 3. Tentukan lokasi dokumen spesifik di Cloud
        // Path: artifacts -> {appId} -> public -> data -> cards -> {id}
        const skillRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"], 'artifacts', __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appId"], 'public', 'data', 'skills', id);
        // 4. Ambil datanya
        const skillSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDoc"])(skillRef);
        // 5. Cek apakah dokumennya ada
        if (!skillSnap.exists()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Card not found in Cloud'
            }, {
                status: 404
            });
        }
        // 6. Kirim data kartu sebagai JSON
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(skillSnap.data());
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2710dabe._.js.map