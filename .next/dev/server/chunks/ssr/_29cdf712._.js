...
function SkillDetailPage() {
    ...
    const skill = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SKILLS_DATA"].find((s)=>s.id === params.id);
    ...
    const mentionedCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const autoDetected = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CARDS_DATA"].filter((card)=>skill.description.includes(card.name));
        // 2. Cari kartu dari list manual 'relatedCards' (Cara Baru)
        const manuallyLinked = skill.relatedCards ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CARDS_DATA"].filter((card)=>skill.relatedCards?.includes(card.id)) : [];
        // 3. Gabungin keduanya
        const combined = [
            ...autoDetected,
            ...manuallyLinked
...
//# sourceMappingURL=_29cdf712._.js.map