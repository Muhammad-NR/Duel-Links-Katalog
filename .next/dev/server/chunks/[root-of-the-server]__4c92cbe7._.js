...
"[project]/lib/def.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
;
}),
"[project]/lib/db/monsters.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/db/spells.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/db/traps.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/db/decks.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/db/skills.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$def$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/def.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$monsters$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/monsters.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$spells$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/spells.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$traps$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/traps.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$decks$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/decks.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$skills$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/skills.ts [app-route] (ecmascript)");
;
;
;
;
...
;
const CARDS_DATA = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$monsters$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MONSTER_CARDS"],
    ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$spells$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SPELL_CARDS"],
    ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$traps$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TRAP_CARDS"]
];
;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/data.ts [app-route] (ecmascript) <locals>");
;
;
async function GET(request) {
    // CCTV 1: Cek apakah CARDS_DATA isinya ada atau kosong [ ]
    console.log("🔥 [API DEBUG] Total Kartu di Server:", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CARDS_DATA"].length);
    const { searchParams } = new URL(request.url);
    const name = searchParams.get('name');
    const type = searchParams.get('type');
    let filteredCards = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CARDS_DATA"];
    if (name) {
        filteredCards = filteredCards.filter((card)=>card.name.toLowerCase().includes(name.toLowerCase()));
    }
    if (type) {
        filteredCards = filteredCards.filter((card)=>card.type.toLowerCase() === type.toLowerCase());
    }
    // CCTV 2: Cek hasil akhir sebelum dikirim ke frontend
    console.log("🔥 [API DEBUG] Kartu dikirim:", filteredCards.length);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(filteredCards);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__4c92cbe7._.js.map