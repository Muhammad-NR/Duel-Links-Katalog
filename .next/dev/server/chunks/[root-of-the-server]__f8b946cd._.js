...
"[project]/app/api/skills/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function GET(request, // Fix Next.js 15: params harus Promise
{ params }) {
    // Fix Next.js 15: Wajib await params
    const { id } = await params;
    const skill = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$skills$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SKILLS_DATA"].find((s)=>s.id === id);
    if (!skill) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(skill);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__f8b946cd._.js.map