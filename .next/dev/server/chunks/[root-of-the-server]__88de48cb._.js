...
"[project]/app/api/cards/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function GET(request, // Perhatikan tipe datanya berubah jadi Promise
{ params }) {
    // WAJIB di-await dulu di Next.js 15
    const { id } = await params;
    // Debugging: Cek ID yang diterima (Opsional, hapus kalau udah jalan)
    console.log("Mencari ID:", id);
    // Cari kartu berdasarkan ID yang sudah di-await
    const card = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CARDS_DATA"].find((c)=>c.id === id);
    if (!card) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__88de48cb._.js.map