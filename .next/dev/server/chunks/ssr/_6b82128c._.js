            ...
            try {
                ...
                if (decksRes.ok) {
                    ...
                    if (configuredDeckIds.length > 0) {
                        topMeta = configuredDeckIds.map((id)=>decksData.find((d)=>d.id === id)).filter((d)=>d !== undefined).slice(0, 3); // Ambil maks 3
                    }
                    if (topMeta.length === 0) {
                        ...
                        topMeta = decksData.filter((d)=>targetTiers.includes(d.tier)).sort(()=>0.5 - Math.random()).slice(0, 3);
                    }
                    // Final Fallback
                    if (topMeta.length === 0) {
