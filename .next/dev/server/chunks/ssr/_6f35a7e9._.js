...
function DeckDetailPage() {
    ...
    const deck = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DECKS_DATA"].find((d)=>d.id === params.id);
    if (!deck) {
    ...
    const getCardByName = (name)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CARDS_DATA"].find((c)=>c.name === name);
    };
    const skillData = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SKILLS_DATA"].find((s)=>s.name === deck.skill);
...
//# sourceMappingURL=_6f35a7e9._.js.map